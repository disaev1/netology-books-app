...
router.post('/', middleware_1.uploadBookFileFields, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newBook;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
router.put('/:id', middleware_1.uploadBookFileFields, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, updatedBook;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
router.get('/:id/download', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, targetBook;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                if (!targetBook.fileBook) {
                    next(new Error("The book with id = ".concat(id, " have no fileBook!")));
                }
                res.download(path_1.default.resolve(__dirname, "../../public/img/".concat(targetBook.fileBook)), targetBook.fileBook, function (err) {
                    if (err) {
                        send404(new errors_1.NotFoundError("File ".concat(targetBook.fileBook, " not found!")), res);
                    }
                });
                return [2 /*return*/];
        }
